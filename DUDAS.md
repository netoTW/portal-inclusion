...
| **ALTA** | ¿Qué exige AIEP para declarar una evidencia "validada": validación estructural automática, revisión humana caso a caso, o mixta (automática + muestreo)? | Define la meta ≥95% y el esfuerzo de GDI; hoy: estructural + rondas de muestreo con reversión ([RF-048](specs/rf/RF-048-validacion-automatica.md)) | [S-21](SUPUESTOS.md) |
