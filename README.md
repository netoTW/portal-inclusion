...
| `specs/modulo-*.md` | Índices por módulo: orden interno de construcción y mapa de cobertura del bloque ([workflow](specs/modulo-workflow.md), [solicitudes](specs/modulo-solicitudes.md), [evidencias](specs/modulo-evidencias.md), [documentos](specs/modulo-documentos.md), [adecuaciones](specs/modulo-adecuaciones.md)) |
